...
while True:
    ...
    if juegoTerminado:
        if jugarDeNuevo():
            ...
            letrasCorrectas = ''
            juegoTerminado = False
            palabraSecreta = obtenerPalabraAlAzar(diccionarioDePalabras)
        else:
            break
